...
<p> This app allows you: 
  <ul>
    <li>Schedule your routine tasks (in dev)</li>
    <li>Motivate yourself and others (only developer is motivated rn)</li>
    <li>Track your time (in dev)</li>
    <li>Sync with your friends!! (not in near future)</li>
  </ul>
</p>
